...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "8.0.12"
  WORKING_DIRECTORY "/Users/albertomartinez/Developer/C++/_Practice_/JUCEcourse/Assignments/02.buildInVSCode/complete/libs/juce"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("8.0.12" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 8.0.12")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/8.0.12")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"8.0.12\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/albertomartinez/Developer/C++/_Practice_/JUCEcourse/Assignments/02.buildInVSCode/complete/libs/juce'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/albertomartinez/Developer/C++/_Practice_/JUCEcourse/Assignments/02.buildInVSCode/complete/libs/juce'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
